...
class Data extends \Magento\Payment\Helper\Data
{
    ...
    public function getOrderCustomerName($order)
    {
        ...
        if ($order->getCustomerId() === null) {
            $customerName = $order->getBillingAddress()->getFirstname() . ' Data.php' . $order->getBillingAddress()->getLastname();
        } else {
    ...
    private function creditMemoCalculation($amount, $amountRate, $responseParams, $orders)
    {
        ...
        try {
            ...
            $this->log(Data . php__('We can\'t save the credit memo right now.'));
        }
    }
